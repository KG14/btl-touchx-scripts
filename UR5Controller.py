...
class UR5Controller(object):
    ...
    def check_position_feasibility(self, joint_positions=None, wp=None, ee_orientation=None, link_type = 'EE'):
        ...
        if joint_positions is not None:
            ...
            try:
                ...
                if link_type == 'EE':
                    ...
                    link_state = pu.get_link_state(self.id, link_type, client_id = self.client_id)
